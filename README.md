...
| 2.2 | Backup Energy Analysis |  Scientific papers [T2.1-T2.3] for evaluating backup-energy options for EV charging when grid power is unavailable. | 📄 [Paper](https://github.com/CastroLab-UCM/EV-Evacuation-Readiness-UCOP/tree/main/Task%202_/Papers) |
