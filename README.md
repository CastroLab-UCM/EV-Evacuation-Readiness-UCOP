...
|---|---|---|---|
| 1.1 | ZEV Evacuation Readiness Framework | Scientific papers [T1.1,T1.3] for evaluating community preparedness for ZEV-based emergency evacuations using resilience indicators | 📄 [Paper](https://github.com/CastroLab-UCM/EV-Evacuation-Readiness-UCOP/tree/main/Task%201_/Papers) |
...
| 2.2 | Backup Energy Analysis |  Scientific papers [T2.1-2.3] for evaluating backup-energy options for EV charging when grid power is unavailable. | 📄 [Paper](https://github.com/CastroLab-UCM/EV-Evacuation-Readiness-UCOP/tree/main/Task%202_/Papers) |
